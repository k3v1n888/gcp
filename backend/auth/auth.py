...
async def login(request: Request):
    # --- THIS IS THE FIX ---
    # Use request.url_for to dynamically and correctly build the redirect URI
    # This ensures it uses https when required.
    redirect_uri = request.url_for('auth_callback')
    return await oauth.google.authorize_redirect(request, redirect_uri)

# --- ADD name='auth_callback' TO THE DECORATOR ---
