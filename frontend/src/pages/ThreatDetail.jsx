...
const DetailCard = ({ title, children, icon }) => (
  <div className="widget-card p-6 mb-6">
    <h2 className="text-xl font-semibold mb-4 flex items-center glow-text">
      {icon}
      {title}
    </h2>
...
export default function ThreatDetail() {
  ...
  if (isLoading) return <div className="p-6 glow-text">Loading Holo-Analysis...</div>;
  if (!threat) return <div className="p-6 text-red-500">Signal Lost. Threat data not found.</div>;
